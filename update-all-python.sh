...
declare -A packages
  if [ "$PYTHON" = 'PY3' ]; then
    packages=(
      ["p7zip"]=1 ["python3-rarfile"]=1 ["libavformat58"]=1 ["libavcodec58"]=1 ["python3-cryptography"]=1 ["libgcc1"]=1 ["libc6"]=1 ["libavcodec61"]=1 ["libavformat61"]=1 ["libasound2"]=1 ["enigma2"]=1 ["alsa-plugins"]=1 ["tar"]=1 ["wget"]=1 ["zip"]=1 ["ar"]=1 ["curl"]=1 ["python3-lxml"]=1 ["python3-requests"]=1
